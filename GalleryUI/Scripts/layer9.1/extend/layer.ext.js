...
//    var e = {};
//    if (a = a || {},a.photos) {
//        var f = a.photos.constructor === Object,
//        g = f ? a.photos: {},
//        h = g.data || [],
//        i = g.start || 0;
//        if (e.imgIndex = i + 1, f) {
...
//            e.imgIndex--,
//            e.imgIndex < 1 && (e.imgIndex = h.length),
//            e.tabimg(a)

//        },
//        e.imgnext = function(a) {
//            e.imgIndex++,
//            e.imgIndex > h.length && (e.imgIndex = 1),
//            e.tabimg(a)
...
//                var b = a.keyCode;
//                a.preventDefault(),
//                37 === b ? e.imgprev(!0) : 39 === b ? e.imgnext(!0) : 27 === b && layer.close(e.index)

//            }

//        },
//        e.tabimg = function(b) {
//            g.start = e.imgIndex - 1,
//            layer.close(e.index),
//            layer.photos({
//                photos: g,
//                full: a.full,
...
//            }),
//            e.bigimg.find(".layui-layer-imgprev").on("click", 
//            function(a) {
//                a.preventDefault(),
//                e.imgprev()

//            }),
//            e.bigimg.find(".layui-layer-imgnext").on("click", 
//            function(a) {
//                a.preventDefault(),
//                e.imgnext()
...
//        function(b) {
//            layer.close(e.loadi),
//            e.index = layer.open($.extend({
//                type: 1,
//                area: function() {
//                    var c = [b.width, b.height],
//                    d = [$(window).width() - 100, $(window).height() - 100];
//                    return ! a.full && c[0] > d[0] && (c[0] = d[0], c[1] = c[0] * d[1] / c[0]),
//                    [c[0] + "px", c[1] + "px"]
...
//                content: '<div class="layui-layer-phimg"><img src="' + h[i].src + '" alt="' + (h[i].alt || "") + '" layer-pid="' + h[i].pid + '"><div class="layui-layer-imgsee"><span class="layui-layer-imguide"><a href="javascript:;" class="layui-layer-iconext layui-layer-imgprev"></a><a href="javascript:;" class="layui-layer-iconext layui-layer-imgnext"></a></span><div class="layui-layer-imgbar" style="display:' + (c ? "block": "") + '"><span class="layui-layer-imgtit"><a href="/Photo/Details?photoId='++'">' + (h[i].alt || "") + "</a><em>" + e.imgIndex + "/" + h.length + "</em></span></div></div></div>",
//                success: function(b) {
//                    e.bigimg = b.find(".layui-layer-phimg"),
//                    e.imgsee = b.find(".layui-layer-imguide,.layui-layer-imgbar"),
//                    e.event(b),
//                    a.tab && a.tab(h[i], b)
